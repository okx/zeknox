...
DEVICE void FFE::_addGeneric(u64 *z, u64 *x, u64 *y)
{
    ...
    // if z > q --> z -= q
    // note: this is NOT constant time
    if (!(z[3] < 3486998266802970665u || (z[3] == 3486998266802970665u && (z[2] < 13281191951274694749u || (z[2] == 13281191951274694749u && (z[1] < 2896914383306846353u || (z[1] == 2896914383306846353u && (z[0] < 4891460686036598785u))))))))
    {
        u64 b, tmp;
        sub64(z[0], 4891460686036598785u, 0, &z[0], &b);
        sub64(z[1], 2896914383306846353u, b, &z[1], &b);
