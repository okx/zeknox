...
const __m256i P_s = _mm256_set_epi64x(0x7FFFFFFF00000001, 0x7FFFFFFF00000001, 0x7FFFFFFF00000001, 0x7FFFFFFF00000001);
...
/*
   // equivalent assembly
   asm inline("vmovdqa   %3, %%ymm13\n" // MSB
              "vmovdqa   %4, %%ymm14\n" // P_s
              "vmovdqa   %5, %%ymm15\n" // P_n
              "vmovdqa   %1, %%ymm11\n" // a
              "vmovdqa   %2, %%ymm12\n" // b
              "vpxor     %%ymm11, %%ymm13, %%ymm11\n"
              "vpcmpgtq  %%ymm14, %%ymm11, %%ymm10\n"
              "vpandn    %%ymm10, %%ymm15, %%ymm10\n"
              "vpaddq    %%ymm10, %%ymm11, %%ymm10\n" // a_sc
              "vpaddq    %%ymm10, %%ymm12, %%ymm11\n" // c0_s
              "vpcmpgtq  %%ymm11, %%ymm10, %%ymm14\n"
              "vpand     %%ymm14, %%ymm15, %%ymm10\n"
              "vpaddq    %%ymm10, %%ymm11, %%ymm10\n"
              "vpxor     %%ymm10, %%ymm13, %%ymm10\n"
              "vmovdqa   %%ymm10, %0\n"
               : "=m"(c)
               : "m"(a), "m"(b), "m"(MSB), "m"(P_s), "m"(P_n)
