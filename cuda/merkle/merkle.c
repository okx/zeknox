...
void fill_init(u64 digests_count, u64 leaves_count, u64 caps_count, u64 leaf_size, u64 hash_size, u64 hash_type)
{
    ...
    // init_gpu(digests_count, caps_count, leaves_count, leaf_size);
}
...
int main()
{
    ...
    fill_digests_buf_in_c(n_digests, n_caps, n_leaves, leaf_size, cap_h);
...
int main4()
{
    ...
    */
    ...
    fill_init(n_digests, n_leaves, n_caps, LEAF_SIZE_U64, HASH_SIZE_U64, 0);
