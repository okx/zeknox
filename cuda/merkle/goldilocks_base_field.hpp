...
/*
    ...
    */
    ...
    static void transpose(svuint64_t &r00, svuint64_t &r01, svuint64_t &r10, svuint64_t &r11, svuint64_t &r20, svuint64_t &r21, svuint64_t &r30, svuint64_t &r31,
                        svuint64_t &c00, svuint64_t &c01, svuint64_t &c10, svuint64_t &c11, svuint64_t &c20, svuint64_t &c21, svuint64_t &c30, svuint64_t &c31);

    static Element dot_sve(const svuint64_t &a0, const svuint64_t &a1, const svuint64_t &a2, const Element b[12]);
    static Element dot_sve(const svuint64_t &a0, const svuint64_t &a1, const svuint64_t &a2, const svuint64_t &a3, const svuint64_t &a4, const svuint64_t &a5, const Element b[12]);
    ...
    static void spmv_sve_4x12(svuint64_t &c0, svuint64_t &c1, const svuint64_t &a0, const svuint64_t &a1, const svuint64_t &a2, const svuint64_t &a3, const svuint64_t &a4, const svuint64_t &a5, const Element b[12]);
    static void spmv_sve_4x12_8(svuint64_t &c0, svuint64_t &c1, const svuint64_t &a0, const svuint64_t &a1, const svuint64_t &a2, const svuint64_t &a3, const svuint64_t &a4, const svuint64_t &a5, const Element b_8[12]);
    ...
    static void mmult_sve_4x12(svuint64_t &b0, svuint64_t &b1, const svuint64_t &a0, const svuint64_t &a1, const svuint64_t &a2, const svuint64_t &a3, const svuint64_t &a4, const svuint64_t &a5, const Element M[48]);
    static void mmult_sve_4x12_8(svuint64_t &b0, svuint64_t &b1, const svuint64_t &a0, const svuint64_t &a1, const svuint64_t &a2, const svuint64_t &a3, const svuint64_t &a4, const svuint64_t &a5, const Element M_8[48]);
    ...
    static void mmult_sve(svuint64_t &a0, svuint64_t &a1, svuint64_t &a2, svuint64_t &a3, svuint64_t &a4, svuint64_t &a5, const Element M[144]);
    static void mmult_sve_8(svuint64_t &a0, svuint64_t &a1, svuint64_t &a2, svuint64_t &a3, svuint64_t &a4, svuint64_t &a5, const Element M_8[144]);
