...
fn test_bn128_add_rust() {
    // no overflow
    let mut a:[u32;8] = [0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,0x00000000,0x00000001];
    let mut b:[u32;8] = [0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,0x00000000,0x00000010];
    ...
    let mut a:[u32;8] = [0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,0x00000000,0xf0000001];
    let mut b:[u32;8] = [0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,0x00000000,0xf0000010];
...
fn test_bn128_sub_rust() {
    // without borrow
    let mut a:[u32;8] = [0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,0x00000000,0xf0000011];
    let mut b:[u32;8] = [0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,0x00000000,0xf0000001];
    let gpu_ret = bn128_sub_rust(&mut a, &mut b);
    assert_eq!(gpu_ret[0],0x00000000 );
    assert_eq!(gpu_ret[7],0x00000010 );

    // no borrow
    let mut a:[u32;8] = [0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,0x00000000,0x00000000];
    let mut b:[u32;8] = [0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,0x00000000,0x00000001];
    let gpu_ret = bn128_sub_rust(&mut a, &mut b);
    println!("ret: {:?}", gpu_ret);
...
fn test_bn128_lshift_rust() {
    ...
    assert_eq!(gpu_ret[7],0x00000004 );
     ...
     let mut a:[u32;8] = [0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,0xffffffff,0xffffff11];
     let mut l: u32 = 1;
     let gpu_ret = bn128_lshift_rust(&mut a, &mut l);
     println!("gpu: {:?}", gpu_ret);
}
...
fn test_bn128_rshift_rust() {
    ...
    // shift right of odd value
     let mut a:[u32;8] = [0x00000001, 0x000000, 0x000000, 0x000000, 0x000000, 0x000000,0x000000,0x00000000];
     let mut l: u32 = 1;
     let gpu_ret = bn128_rshift_rust(&mut a, &mut l);
     println!("gpu: {:?}", gpu_ret);
}