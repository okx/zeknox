...
#ifdef USE_CUDA
#define SECP256K1_INLINE __host__ __device__ inline
#define SECP256K1_FUNC  __host__ __device__
#ifdef __CUDA_ARCH__
#define SECP256K1_STATIC_CONST static __constant__ __device__
#else
#define SECP256K1_STATIC_CONST static const
#endif
#ifdef __CUDA_ARCH__
#define SECP256K1_CONST __constant__ __device__
#else
#define SECP256K1_CONST const
#endif
#else
#define SECP256K1_INLINE inline
#define SECP256K1_FUNC
#define SECP256K1_STATIC_CONST static const
#define SECP256K1_CONST const
#endif
...
SECP256K1_FUNC static void secp256k1_default_illegal_callback_fn(const char* str, void* data) {
    (void)data;
    printf("[libsecp256k1] illegal argument: %s\n", str);
    assert(0);
}
SECP256K1_FUNC static void secp256k1_default_error_callback_fn(const char* str, void* data) {
    (void)data;
...
SECP256K1_STATIC_CONST secp256k1_callback default_illegal_callback = {
    secp256k1_default_illegal_callback_fn,
    NULL
};

SECP256K1_STATIC_CONST secp256k1_callback default_error_callback = {
...
static SECP256K1_INLINE int secp256k1_ctz32_var_debruijn(uint32_t x) {
    SECP256K1_STATIC_CONST uint8_t debruijn[32] = {
...
static SECP256K1_INLINE int secp256k1_ctz64_var_debruijn(uint64_t x) {
    SECP256K1_STATIC_CONST uint8_t debruijn[64] = {
