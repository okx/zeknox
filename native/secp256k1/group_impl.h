...
SECP256K1_STATIC_CONST secp256k1_ge secp256k1_ge_const_g = SECP256K1_G;
...
SECP256K1_FUNC static void secp256k1_ge_set_gej_zinv(secp256k1_ge *r, const secp256k1_gej *a, const secp256k1_fe *zi) {
    secp256k1_fe zi2;
    secp256k1_fe zi3;
...
/* Set r to the affine coordinates of Jacobian point (a.x, a.y, 1/zi). */
SECP256K1_FUNC static void secp256k1_ge_set_ge_zinv(secp256k1_ge *r, const secp256k1_ge *a, const secp256k1_fe *zi) {
    secp256k1_fe zi2;
    secp256k1_fe zi3;
...
SECP256K1_FUNC static void secp256k1_gej_rescale(secp256k1_gej *r, const secp256k1_fe *s) {
