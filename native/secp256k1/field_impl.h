...
#ifndef VERIFY
SECP256K1_FUNC static void secp256k1_fe_verify(const secp256k1_fe *a) { (void)a; }
SECP256K1_FUNC static void secp256k1_fe_verify_magnitude(const secp256k1_fe *a, int m) { (void)a; (void)m; }
#else
SECP256K1_FUNC static void secp256k1_fe_impl_verify(const secp256k1_fe *a);
...
SECP256K1_FUNC static void secp256k1_fe_impl_normalize(secp256k1_fe *r);
...
SECP256K1_FUNC static void secp256k1_fe_impl_normalize_weak(secp256k1_fe *r);
...
SECP256K1_FUNC static void secp256k1_fe_impl_normalize_var(secp256k1_fe *r);
...
SECP256K1_FUNC static int secp256k1_fe_impl_normalizes_to_zero(const secp256k1_fe *r);
...
SECP256K1_FUNC static int secp256k1_fe_impl_normalizes_to_zero_var(const secp256k1_fe *r);
...
SECP256K1_FUNC static void secp256k1_fe_impl_set_int(secp256k1_fe *r, int a);
...
SECP256K1_FUNC static void secp256k1_fe_impl_add_int(secp256k1_fe *r, int a);
...
SECP256K1_FUNC static void secp256k1_fe_impl_clear(secp256k1_fe *a);
...
SECP256K1_FUNC static int secp256k1_fe_impl_is_zero(const secp256k1_fe *a);
...
SECP256K1_FUNC static int secp256k1_fe_impl_is_odd(const secp256k1_fe *a);
...
SECP256K1_FUNC static int secp256k1_fe_impl_cmp_var(const secp256k1_fe *a, const secp256k1_fe *b);
...
SECP256K1_FUNC static void secp256k1_fe_impl_set_b32_mod(secp256k1_fe *r, const unsigned char *a);
...
SECP256K1_FUNC static int secp256k1_fe_impl_set_b32_limit(secp256k1_fe *r, const unsigned char *a);
...
SECP256K1_FUNC static void secp256k1_fe_impl_get_b32(unsigned char *r, const secp256k1_fe *a);
...
SECP256K1_FUNC static void secp256k1_fe_impl_negate_unchecked(secp256k1_fe *r, const secp256k1_fe *a, int m);
...
SECP256K1_FUNC static void secp256k1_fe_impl_mul_int_unchecked(secp256k1_fe *r, int a);
...
SECP256K1_FUNC static void secp256k1_fe_impl_add(secp256k1_fe *r, const secp256k1_fe *a);
...
SECP256K1_FUNC static void secp256k1_fe_impl_mul(secp256k1_fe *r, const secp256k1_fe *a, const secp256k1_fe * SECP256K1_RESTRICT b);
...
SECP256K1_FUNC static void secp256k1_fe_impl_sqr(secp256k1_fe *r, const secp256k1_fe *a);
...
SECP256K1_FUNC static void secp256k1_fe_impl_cmov(secp256k1_fe *r, const secp256k1_fe *a, int flag);
...
SECP256K1_FUNC static void secp256k1_fe_impl_to_storage(secp256k1_fe_storage *r, const secp256k1_fe *a);
...
SECP256K1_FUNC static void secp256k1_fe_impl_from_storage(secp256k1_fe *r, const secp256k1_fe_storage *a);
...
SECP256K1_FUNC static void secp256k1_fe_impl_inv(secp256k1_fe *r, const secp256k1_fe *x);
...
SECP256K1_FUNC static void secp256k1_fe_impl_inv_var(secp256k1_fe *r, const secp256k1_fe *x);
...
SECP256K1_FUNC static int secp256k1_fe_impl_is_square_var(const secp256k1_fe *x);
...
SECP256K1_FUNC static void secp256k1_fe_impl_get_bounds(secp256k1_fe* r, int m);
...
SECP256K1_FUNC static void secp256k1_fe_impl_half(secp256k1_fe *r);
