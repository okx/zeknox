...
SECP256K1_FUNC static void secp256k1_scalar_reduce_512(secp256k1_scalar *r, const uint32_t *l) {
    uint64_t c;
...
SECP256K1_FUNC static void secp256k1_scalar_mul_512(uint32_t *l, const secp256k1_scalar *a, const secp256k1_scalar *b) {
    /* 96 bit accumulator. */
...
SECP256K1_FUNC static void secp256k1_scalar_from_signed30(secp256k1_scalar *r, const secp256k1_modinv32_signed30 *a) {
...
SECP256K1_FUNC static void secp256k1_scalar_to_signed30(secp256k1_modinv32_signed30 *r, const secp256k1_scalar *a) {
...
SECP256K1_STATIC_CONST secp256k1_modinv32_modinfo secp256k1_const_modinfo_scalar = {
