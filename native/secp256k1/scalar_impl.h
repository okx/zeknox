...
#ifdef __CUDA_ARCH__
static __constant__ __device__ secp256k1_scalar secp256k1_scalar_one = SECP256K1_SCALAR_CONST(0, 0, 0, 0, 0, 0, 0, 1);
static __constant__ __device__ secp256k1_scalar secp256k1_scalar_zero = SECP256K1_SCALAR_CONST(0, 0, 0, 0, 0, 0, 0, 0);
#else
 ...
 * lambda is: */
SECP256K1_STATIC_CONST secp256k1_scalar secp256k1_const_lambda = SECP256K1_SCALAR_CONST(
