...
#ifdef USE_CUDA
#  define SECP256K1_API __host__ __device__
#else
 ...
 */
#ifdef __CUDA_ARCH__
extern __constant__ __device__ secp256k1_context *secp256k1_context_static;
#else
 ...
 * extra entropy.
 */
extern SECP256K1_CONST secp256k1_nonce_function secp256k1_nonce_function_rfc6979;

/** A default safe nonce generation function (currently equal to secp256k1_nonce_function_rfc6979). */
extern SECP256K1_CONST secp256k1_nonce_function secp256k1_nonce_function_default;
