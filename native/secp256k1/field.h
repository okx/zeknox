...
SECP256K1_STATIC_CONST secp256k1_fe secp256k1_fe_one = SECP256K1_FE_CONST(0, 0, 0, 0, 0, 0, 0, 1);
SECP256K1_STATIC_CONST secp256k1_fe secp256k1_const_beta = SECP256K1_FE_CONST(
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_normalize(secp256k1_fe *r);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_normalize_weak(secp256k1_fe *r);

/** Normalize a field element, without constant-time guarantee.
 *
 * Identical in behavior to secp256k1_fe_normalize, but not constant time in r.
 */
SECP256K1_FUNC static void secp256k1_fe_normalize_var(secp256k1_fe *r);
 ...
 */
SECP256K1_FUNC static int secp256k1_fe_normalizes_to_zero(const secp256k1_fe *r);
 ...
 */
SECP256K1_FUNC static int secp256k1_fe_normalizes_to_zero_var(const secp256k1_fe *r);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_set_int(secp256k1_fe *r, int a);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_clear(secp256k1_fe *a);
 ...
 */
SECP256K1_FUNC static int secp256k1_fe_is_zero(const secp256k1_fe *a);
 ...
 */
SECP256K1_FUNC static int secp256k1_fe_is_odd(const secp256k1_fe *a);
 ...
 * Returns a = b (mod p).
 */
SECP256K1_FUNC static int secp256k1_fe_equal(const secp256k1_fe *a, const secp256k1_fe *b);
 ...
 * in range 0..p-1).
 */
SECP256K1_FUNC static int secp256k1_fe_cmp_var(const secp256k1_fe *a, const secp256k1_fe *b);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_set_b32_mod(secp256k1_fe *r, const unsigned char *a);
 ...
 */
SECP256K1_FUNC static int secp256k1_fe_set_b32_limit(secp256k1_fe *r, const unsigned char *a);
 ...
 * On output, r = a (mod p).
 */
SECP256K1_FUNC static void secp256k1_fe_get_b32(unsigned char *r, const secp256k1_fe *a);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_negate_unchecked(secp256k1_fe *r, const secp256k1_fe *a, int m);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_add_int(secp256k1_fe *r, int a);
 ...
 * Should not be called directly outside of tests.
 */
SECP256K1_FUNC static void secp256k1_fe_mul_int_unchecked(secp256k1_fe *r, int a);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_add(secp256k1_fe *r, const secp256k1_fe *a);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_mul(secp256k1_fe *r, const secp256k1_fe *a, const secp256k1_fe * SECP256K1_RESTRICT b);
 ...
 * On output, r will have magnitude 1, but won't be normalized.
 */
SECP256K1_FUNC static void secp256k1_fe_sqr(secp256k1_fe *r, const secp256k1_fe *a);
 ...
 */
SECP256K1_FUNC static int secp256k1_fe_sqrt(secp256k1_fe * SECP256K1_RESTRICT r, const secp256k1_fe * SECP256K1_RESTRICT a);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_inv(secp256k1_fe *r, const secp256k1_fe *a);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_inv_var(secp256k1_fe *r, const secp256k1_fe *a);
 ...
 * Performs {r = a}.
 */
SECP256K1_FUNC static void secp256k1_fe_to_storage(secp256k1_fe_storage *r, const secp256k1_fe *a);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_from_storage(secp256k1_fe *r, const secp256k1_fe_storage *a);

/** If flag is true, set *r equal to *a; otherwise leave it. Constant-time.  Both *r and *a must be initialized.*/
SECP256K1_FUNC static void secp256k1_fe_storage_cmov(secp256k1_fe_storage *r, const secp256k1_fe_storage *a, int flag);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_cmov(secp256k1_fe *r, const secp256k1_fe *a, int flag);
 ...
 */
SECP256K1_FUNC static void secp256k1_fe_half(secp256k1_fe *r);
 ...
 *  internal overflows. */
SECP256K1_FUNC static void secp256k1_fe_get_bounds(secp256k1_fe *r, int m);

/** Determine whether a is a square (modulo p).
 *
 * On input, a must be a valid field element.
 */
SECP256K1_FUNC static int secp256k1_fe_is_square_var(const secp256k1_fe *a);

/** Check invariants on a field element (no-op unless VERIFY is enabled). */
SECP256K1_FUNC static void secp256k1_fe_verify(const secp256k1_fe *a);
#define SECP256K1_FE_VERIFY(a) secp256k1_fe_verify(a)

/** Check that magnitude of a is at most m (no-op unless VERIFY is enabled). */
SECP256K1_FUNC static void secp256k1_fe_verify_magnitude(const secp256k1_fe *a, int m);
