...
SECP256K1_FUNC static void secp256k1_sha256_initialize(secp256k1_sha256 *hash) {
...
SECP256K1_FUNC static void secp256k1_sha256_transform(uint32_t* s, const unsigned char* buf) {
...
SECP256K1_FUNC static void secp256k1_sha256_write(secp256k1_sha256 *hash, const unsigned char *data, size_t len) {
...
SECP256K1_FUNC static void secp256k1_sha256_finalize(secp256k1_sha256 *hash, unsigned char *out32) {
...
SECP256K1_FUNC static void secp256k1_sha256_initialize_tagged(secp256k1_sha256 *hash, const unsigned char *tag, size_t taglen) {
...
SECP256K1_FUNC static void secp256k1_hmac_sha256_initialize(secp256k1_hmac_sha256 *hash, const unsigned char *key, size_t keylen) {
    size_t n;
...
SECP256K1_FUNC static void secp256k1_hmac_sha256_write(secp256k1_hmac_sha256 *hash, const unsigned char *data, size_t size) {
    secp256k1_sha256_write(&hash->inner, data, size);
}

SECP256K1_FUNC static void secp256k1_hmac_sha256_finalize(secp256k1_hmac_sha256 *hash, unsigned char *out32) {
...
SECP256K1_FUNC static void secp256k1_rfc6979_hmac_sha256_initialize(secp256k1_rfc6979_hmac_sha256 *rng, const unsigned char *key, size_t keylen) {
...
SECP256K1_FUNC static void secp256k1_rfc6979_hmac_sha256_generate(secp256k1_rfc6979_hmac_sha256 *rng, unsigned char *out, size_t outlen) {
    /* RFC6979 3.2.h. */
    static const unsigned char zero[1] = {0x00};
    if (rng->retry) {
        secp256k1_hmac_sha256 hmac;
...
SECP256K1_FUNC static void secp256k1_rfc6979_hmac_sha256_finalize(secp256k1_rfc6979_hmac_sha256 *rng) {
    memset(rng->k, 0, 32);
    memset(rng->v, 0, 32);
    rng->retry = 0;
}
