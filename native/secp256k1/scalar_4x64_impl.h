...
SECP256K1_FUNC static void secp256k1_scalar_set_b32(secp256k1_scalar *r, const unsigned char *b32, int *overflow) {
    int over;
...
SECP256K1_FUNC static int secp256k1_scalar_cond_negate(secp256k1_scalar *r, int flag) {
...
SECP256K1_FUNC static void secp256k1_scalar_reduce_512(secp256k1_scalar *r, const uint64_t *l) {
...
SECP256K1_FUNC static void secp256k1_scalar_mul_512(uint64_t *l8, const secp256k1_scalar *a, const secp256k1_scalar *b) {
#ifdef USE_ASM_X86_64
...
SECP256K1_FUNC static void secp256k1_scalar_from_signed62(secp256k1_scalar *r, const secp256k1_modinv64_signed62 *a) {
...
SECP256K1_FUNC static void secp256k1_scalar_to_signed62(secp256k1_modinv64_signed62 *r, const secp256k1_scalar *a) {
...
SECP256K1_STATIC_CONST secp256k1_modinv64_modinfo secp256k1_const_modinfo_scalar = {
    {{0x3FD25E8CD0364141LL, 0x2ABB739ABD2280EELL, -0x15LL, 0, 256}},
    0x34F20099AA774EC1LL
};

SECP256K1_FUNC static void secp256k1_scalar_inverse(secp256k1_scalar *r, const secp256k1_scalar *x) {
...
SECP256K1_FUNC static void secp256k1_scalar_inverse_var(secp256k1_scalar *r, const secp256k1_scalar *x) {
    secp256k1_modinv64_signed62 s;
#ifdef VERIFY
    int zero_in = secp256k1_scalar_is_zero(x);
#endif
