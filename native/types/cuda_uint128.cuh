...
#endif
      friend uint128_t
      operator+(uint128_t a, const T &b)
  {
    return add128(a, b);
  }
...
#error Architecture not supported
...
#endif
      friend T
      operator/(uint128_t x, const T &v)
  {
    return div128to64(x, (uint64_t)v);
  }
...
#endif
      friend bool
      operator<(uint128_t a, uint128_t b)
  {
  ...
  __device__
      ...
      operator|(uint128_t a, const T &b)
  {
    return bitwiseOr(a, (uint128_t)b);
  }
  ...
  __device__
      ...
      operator&(uint128_t a, const T &b)
  {
    return bitwiseAnd(a, (uint128_t)b);
  }
  ...
  __device__
      ...
      operator^(uint128_t a, const T &b)
  {
    return bitwiseXor(a, (uint128_t)b);
  }
...
#endif
      static bool
      isLessThan(uint128_t a, uint128_t b)
  {
    if (a.hi < b.hi)
      return 1;
    if (a.hi > b.hi)
...
#endif
      static bool
      isLessThanOrEqual(uint128_t a, uint128_t b)
  {
    if (a.hi < b.hi)
      return 1;
    if (a.hi > b.hi)
...
#endif
      static bool
      isGreaterThan(uint128_t a, uint128_t b)
  {
    if (a.hi < b.hi)
      return 0;
    if (a.hi > b.hi)
...
#endif
      static bool
      isGreaterThanOrEqual(uint128_t a, uint128_t b)
  {
    if (a.hi < b.hi)
      return 0;
    if (a.hi > b.hi)
...
#endif
      static bool
      isEqualTo(uint128_t a, uint128_t b)
  {
...
#endif
      static bool
      isNotEqualTo(uint128_t a, uint128_t b)
  {
    if (a.lo != b.lo || a.hi != b.hi)
      return 1;
    else
...
/// This just makes it more convenient to count leading zeros for uint128_t
...
#endif
      static uint128_t
      bitwiseOr(uint128_t a, uint128_t b)
  {
    a.lo |= b.lo;
    a.hi |= b.hi;
    return a;
...
#endif
      static uint128_t
      bitwiseAnd(uint128_t a, uint128_t b)
  {
    a.lo &= b.lo;
    a.hi &= b.hi;
    return a;
...
#endif
      static uint128_t
      bitwiseXor(uint128_t a, uint128_t b)
  {
    a.lo ^= b.lo;
    a.hi ^= b.hi;
    return a;
  ...
  __device__
      ...
      add128(uint128_t x, uint128_t y)
  {
#ifdef __CUDA_ARCH__
    uint128_t res;
    asm("add.cc.u64    %0, %2, %4;\n\t"
...
#endif
      static inline uint64_t
      div128to64(uint128_t x, uint64_t v, uint64_t *r = NULL) // x / v
  {
...
#endif
      static inline uint128_t
      div128to128(uint128_t x, uint64_t v, uint64_t *r = NULL)
  {
    uint128_t res;
...
#endif
      static inline uint128_t
      sub128(uint128_t x, uint128_t y) // x - y
  {
    uint128_t res;
...
#endif
      friend inline uint128_t
      sub128(uint128_t x, uint128_t y);
...
#endif
      static inline uint64_t
      _isqrt(const uint128_t &x) // this gives errors above 2^124
  {
    uint64_t res0 = 0;

    if (x.lo == 0 || x.hi > 1ull << 60)
      return 0;
...
#pragma unroll
  ...
  __device__
      ...
      u128_to_double(uint128_t x)
  {
    double dbl;
#ifdef __CUDA_ARCH__
    if (x.hi == 0)
      return __ull2double_rd(x.lo);
#else
    if (x.hi == 0)
      return (double)x.lo;
#endif
...
#endif
      friend inline float
      u128_to_float(uint128_t x)
  {
    float flt;
#ifdef __CUDA_ARCH__
    if (x.hi == 0)
      return __ull2float_rd(x.lo);
#else
    if (x.hi == 0)
      return (float)x.lo;
#endif
...
#endif
    inline uint64_t
    div128to64(uint128_t x, uint64_t v, uint64_t *r = NULL)
{
